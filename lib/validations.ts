...
export const AskQuestionSchema = z.object({
    ...
    content: z.string().min(100, { message: "Content must have minimum of 100 characters." }),
    tags: z
        .array(
            z
                .string()
...
export const AnswerSchema = z.object({
    content: z.string().min(100, { message: "Answer must have minimum of 100 characters." }),
});
