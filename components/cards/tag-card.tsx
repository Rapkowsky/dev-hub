...
const TagCard = ({
    ...
    const Content = (
        <>
            <Badge className="subtle-medium background-light800_dark300 text-light400_light500 hover-text click-anim flex flex-row gap-2 rounded-md border-none px-4 py-2 uppercase transition-transform duration-300">
